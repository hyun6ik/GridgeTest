...
public interface MemberConstraints {
    ...
    String UPDATE_PRIVATE = "비공개 계정으로 전환되었습니다.";
    String RESIGN_MEMBER = "회원 탈퇴가 완료되었습니다.";
    String UPDATE_WEBSITE = "웹사이트 수정이 완료되었습니다.";
    ...
    String PRIVATE_REJECT_MEMBER = "팔로우 승인을 거절하였습니다.";
